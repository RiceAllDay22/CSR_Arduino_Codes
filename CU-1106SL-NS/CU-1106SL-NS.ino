/*
  The following code is intended specifically for the CU-1106 SL-NS model.
...
int calValue = 400;      //Calibration value that the sensor will be calibrated to when the button is pressed. Range is 400 to 1500. DO NOT GO OUT OF RANGE
///////////////////////
