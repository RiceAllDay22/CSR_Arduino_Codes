/*
  The following code is intended specifically for the CU-1106SL-NS model.
  Ensure that the ssensor has been wired properly, before running this code.
  This code uses UART communication to send and recieve information to and from the CU-1106SL-NS sensor.
 */
