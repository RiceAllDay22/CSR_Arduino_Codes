/*
  The following code is intended specifically for the CU-1106-C model and an Arduino Mega.
...
int calValue = 1100;            //Calibration value that the sensor will be calibrated to when the button is pressed.
